...
function create_dialogo_liang(s,player){
    ...
    liang = PP.assets.image.add(s,img_liang,1500,1238,0,0);
    ...
    casella_zhu_dialogo_liang = PP.assets.image.add(s,img_casella_zhu_dialogo_liang,450,1370,0,0);
    casella_zhu_dialogo_liang.visibility.alpha=0;
    testo_dialogofinale_positivo1 = PP.assets.image.add(s,img_testo_dialogofinale_positivo1,1230,1420,0,0);
    testo_dialogofinale_positivo1.visibility.alpha = 0;
    testo_dialogofinale_positivo2 = PP.assets.image.add(s,img_testo_dialogofinale_positivo2,1230,1420,0,0);
